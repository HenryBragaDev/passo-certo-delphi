object TelaAdicionarEstoque: TTelaAdicionarEstoque
  Left = 0
  Top = 0
  Align = alClient
  BorderStyle = bsNone
  ...
  object pnlFundo: TPanel
    ...
    object pnlborda: TPanel
      ...
      object pnlItens: TPanel
        ...
        object edtTamanhoProduto: TEdit
          Left = 256
          Top = 220
          Width = 105
          Height = 30
          ...
          ParentFont = False
          TabOrder = 3
          OnKeyPress = edtTamanhoProdutoKeyPress
        end
  ...
  object ADOQueryEstoque_Categorias: TADOQuery
    Connection = DMPrincipal.ADOConnectionGeral
    Parameters = <>
    Left = 80
    Top = 752
  end
  object DataSourceEstoque_Categorias: TDataSource
    DataSet = ADOQueryEstoque_Categorias
    Left = 136
    Top = 728
  end
  object ADOQueryEstoque_Produtos: TADOQuery
    Connection = DMPrincipal.ADOConnectionGeral
    Parameters = <>
    Left = 335
    Top = 736
  end
  object DataSourceEstoque_Produtos: TDataSource
    DataSet = ADOQueryEstoque_Produtos
    Left = 415
    Top = 712
  end
  object ADOQueryEstoque_Fornecedor: TADOQuery
    Connection = DMPrincipal.ADOConnectionGeral
    Parameters = <>
    Left = 607
    Top = 744
  end
  object DataSourceEstoque_Fornecedor: TDataSource
    DataSet = ADOQueryEstoque_Fornecedor
    Left = 679
    Top = 736
  end
