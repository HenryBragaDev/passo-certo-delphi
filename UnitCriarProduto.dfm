object criarProduto: TcriarProduto
  Left = 0
  Top = 0
  Align = alClient
  BorderStyle = bsNone
  Caption = 'criarProduto'
  ClientHeight = 865
  ClientWidth = 1133
  Color = clBackground
    ...
    object pnlborda: TPanel
      ...
      object pnlItens: TPanel
        ...
        object edtCategoriaProduto: TEdit
          ...
          ParentFont = False
          TabOrder = 1
          OnKeyPress = edtCategoriaProdutoKeyPress
        end
  ...
  object ADOConnectionCriarProduto: TADOConnection
    Connected = True
    ConnectionString = 
  ...
  object DataSourceCriarProduto: TDataSource
    DataSet = ADOQueryCriarProduto
    Left = 744
    Top = 744
  end
  object ADOQueryVerificaProduto: TADOQuery
    Connection = ADOConnectionCriarProduto
    CursorType = ctStatic
    Parameters = <>
    Left = 863
    Top = 728
  end
  object ADOQueryCriarProduto: TADOQuery
    Connection = ADOConnectionCriarProduto
    Parameters = <>
    Left = 191
    Top = 736
  end
  object DataSourceVerificaProduto: TDataSource
    DataSet = ADOQueryVerificaProduto
    Left = 919
    Top = 704
  end
end
